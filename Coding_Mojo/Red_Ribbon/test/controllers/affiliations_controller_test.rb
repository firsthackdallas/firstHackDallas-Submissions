...
class AffiliationsControllerTest < ActionController::TestCase
  ...
  test "should create affiliation" do
    assert_difference('Affiliation.count') do
      post :create, affiliation: { affiliation: @affiliation.affiliation, service_provider_id: @affiliation.service_provider_id }
    end
  ...
  test "should update affiliation" do
    patch :update, id: @affiliation, affiliation: { affiliation: @affiliation.affiliation, service_provider_id: @affiliation.service_provider_id }
    assert_redirected_to affiliation_path(assigns(:affiliation))
  end
